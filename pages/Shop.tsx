      ...
      <div className="max-w-[1440px] mx-auto px-4 md:px-8">
        ...
        <header className="mb-12">
          <motion.h1 
            ...
            className="text-5xl md:text-7xl font-black text-charcoal mb-6 uppercase tracking-tighter"
          >
...
const ShopProductCard: React.FC<{ product: any, index: number }> = ({ product, index }) => {
  ...
  return (
    ...
    >
      ...
      <div className="mt-6">
        <h3 className="text-sm font-black text-charcoal group-hover:text-primary transition-colors truncate uppercase tracking-tight">{product.name}</h3>
        <p className="text-[10px] text-charcoal/30 font-black uppercase tracking-[0.2em] mt-1 mb-3">{product.category}</p>
