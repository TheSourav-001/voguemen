  ...
  return (
    <div className="pt-24 md:pt-40 pb-24 bg-offwhite min-h-screen">
      <div className="max-w-[1440px] mx-auto px-4 md:px-8">
        <h1 className="text-3xl md:text-5xl font-black text-charcoal mb-8 md:mb-12 uppercase tracking-tight">Shopping Cart</h1>
            ...
            <AnimatePresence>
              {cart.map((item) => (
                <motion.div
                  ...
                  exit={{ opacity: 0, x: 20 }}
                  className="bg-white p-4 md:p-6 rounded-2xl border border-border flex flex-col sm:flex-row gap-4 md:gap-8 items-start sm:items-center"
                >
